...
function freezePanes(){
	...
	$('.grid tbody').append('<tr><td style="padding:0; border:0 none;" colspan="'+cols+'"><div class="grid-fixed-height"><table cellspacing="1" border="0" style="width:100%" cellspadding="0"></table></div></td></tr>');
