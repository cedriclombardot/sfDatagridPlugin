...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  var crlf = "\r\n";
  var TABLE = "<table style='width:200px' cols=7 class='dpTable' cellspacing='0'>" + crlf;
  ...
  var TD_buttons = "<td class='dpButtonTD' valign='top'>";
  var TD_todaybutton = "<td colspan=7 class='dpTodayButtonTD'>";
  var TD_days = "<td class='dpDayTD'>";
  var TD_off = "<td class='dpTDOff' ";
  ...
  html += "<a class='dpTodayButton' onClick='refreshDatePicker(\"" + dateFieldName + "\");'>Today</a> ";
  html += "<a class='dpTodayButton' onClick='updateDateField(\"" + dateFieldName + "\");'>Close</a>";
  html += xTD + xTR;
