 ...
 * @version    SVN: $Id: sfDatagridModelGeneratorConfiguration.class.php $
 */
abstract class sfDatagridModelGeneratorConfiguration
{
  protected
    $configuration = array();
  ...
  protected function compile()
  {
    ...
    $this->configuration = array(
      'list'   => array(
        ...
        //Datagrid add
        'use_datagrid'   => $this->indexActionUseDatagrid(),
