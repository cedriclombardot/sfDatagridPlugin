 ...
 */
abstract class Base<?php echo ucfirst($this->getModuleName()) ?>GeneratorConfiguration extends sfDatagridModelGeneratorConfiguration
{

<?php include dirname(__FILE__).'/datagridConfiguration.php' ?>
